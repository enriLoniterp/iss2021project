	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		return { //this:ActionBasciFsm
				...
				state("tMoveToSlotIn") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("moveToSlotIn(X,Y)"), Term.createTerm("tMoveToSlotIn(X,Y)"), 
				...
				state("tMoveToSlotOut") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("moveToSlotOut(X,Y)"), Term.createTerm("tMoveToSlotOut(X,Y)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
