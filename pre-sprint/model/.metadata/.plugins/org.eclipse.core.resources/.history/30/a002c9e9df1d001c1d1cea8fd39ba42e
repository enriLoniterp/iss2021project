...
package it.unibo.activecomponentscontroller
...
class Activecomponentscontroller ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						println("activecomponentscontroller STARTS")
					}
					 transition( edgeName="goto",targetState="work", cond=doswitch() )
				}	 
				state("work") { //this:State
					action { //it:State
						println("activecomponentscontroller   | waiting .................. ")
					}
				...
				state("moveTrolleyToIn") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("moveToIn(MOVETOIN)"), Term.createTerm("moveToIn(MTOIN)"), 
								...
								println("activecomponentscontroller   | move the Trolley to the INDOOR ")
				...
				state("checkTMovedToIn") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("tMovedToIn(SUCCESS)"), Term.createTerm("tMovedToIn(MTOIN)"), 
								 ...
								 var m =  payloadArg(0)  
								if(  m != "problem"  
								 ){println("activecomponentscontroller   | car picked up by the Trolley ")
								forward("secondW", "secondW(sW)" ,"weightsensor" ) 
								answer("moveToIn", "movedToIn", "movedToIn(moved)"   )  
								}
								else
								 {println("activecomponentscontroller   | car not picked up by the Trolley ")
				...
				state("moveTrolleyToSlotIn") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("moveToSlotIn(X,Y)"), Term.createTerm("moveToSlotIn(X,Y)"), 
								...
								println("activecomponentscontroller   | move the Trolley(with the car) to the parking-slot in ($X,$Y) ")
				...
				state("checkTMovedToSlotIn") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("tMovedToSlotIn(SUCCESS,X,Y)"), Term.createTerm("tMovedToSlotIn(SUCCESS,X,Y)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								println("activecomponentscontroller   qui ")
								 var m =  payloadArg(0)  
								if(  m != "problem"  
								 ){println("activecomponentscontroller   | car parked")
								answer("moveToSlotIn", "movedToSlotIn", "movedToSlotIn(moved)"   )  
								}
								else
								 {println("activecomponentscontroller   | car not parked")
				...
				state("moveTrolleyToSlotOut") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("moveToSlotOut(X,Y)"), Term.createTerm("moveToSlotOut(X,Y)"), 
												...
												var X = payloadArg(0).toInt()
												var Y = payloadArg(1).toInt()
								println("activecomponentscontroller   | move the Trolley to the parking-slot in ($X,$Y) ")
				...
				state("checkTMovedToSlotOut") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("tMovedToSlotOut(SUCCESS,X,Y)"), Term.createTerm("tMovedToSlotOut(SUCCES,X,Y)"), 
								 ...
								 var m =  payloadArg(0)  
								if(  m != "problem"  
								 ){println("activecomponentscontroller   | trolley moved to slot out")
								answer("moveToSlotOut", "movedToSlotOut", "movedToSlotOut(moved,3,2)"   )  
								}
								else
								 {println("activecomponentscontroller   | trolley not moved to slot out")
				...
				state("moveTrolleyToOut") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("moveToOut(X,Y)"), Term.createTerm("moveToOut(X,Y)"), 
												...
												var X = payloadArg(0).toInt()
												var Y = payloadArg(1).toInt()
								println("activecomponentscontroller   | move the Trolley to out")
				...
				state("checkTMovedToOut") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("tMovedToOut(SUCCESS)"), Term.createTerm("tMovedToOut(SUCCESS)"), 
								 ...
								 var m =  payloadArg(0)  
								if(  m != "problem"  
								 ){println("activecomponentscontroller   | trolley with car moved to out")
								forward("firstOS", "firstOS(fOS)" ,"outsonar" ) 
								answer("moveToOut", "movedToOut", "movedToOut(moved)"   )  
								}
								else
								 {println("activecomponentscontroller   | trolley not moved to out")
				...
				state("moveTrolleyToHome") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("backToHome(X)"), Term.createTerm("backToHome(X)"), 
								...
								println("activecomponentscontroller   | move the Trolley to home")
				...
				state("checkTMovedToHome") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("tMovedToHome(Y)"), Term.createTerm("tMovedToHome(MTOIN)"), 
								 ...
								 var m =  payloadArg(0)  
								if(  m != "problem"  
								 ){println("activecomponentscontroller   | trolley moved to home")
								answer("backToHome", "movedToHome", "movedToHome(moved)"   )  
								}
								else
								 {println("activecomponentscontroller   | trolley not moved to home")
